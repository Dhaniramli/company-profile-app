<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ (Request::is('admin/survey-masyarakat*') || Request::is('admin/pengaduan-masyarakat*') || Request::is('admin/hasil-survey-masyarakat*')) ? 'active' : '' }}">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ (Request::is('admin/survey-masyarakat*') || Request::is('admin/hasil-survey-masyarakat*')) ? 'active' : '' }}" href="/admin/survey-masyarakat">Survey Masyarakat</a>
            </div>
        </div>
    </li>
